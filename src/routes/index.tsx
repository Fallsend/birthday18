...
const REASONS: string[] = [
  ...
  'How you never let a hard day turn into a hard week.',
  'The way you ask "did you eat?" before anything else.',
  'Your fierce loyalty to the people you love.',
  'How you turn my worst days into something we can laugh about later.',
  'The way your voice softens right before you say something kind.',
  'How you never stop learning, growing, becoming more you.',
